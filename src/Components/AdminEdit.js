      ...
      try {
        ...
        if (res.data.success) {
          ...
          if (latestImage) {
            ...
            setAdminImage("http://13.200.229.88:9000/assets/images/avatar/07.jpg"); 
            setPreview("http://13.200.229.88:9000/assets/images/avatar/07.jpg");
...
console.log("Stored Image URL in LocalStorage: ", storedImage);    if (storedImage) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.status === 200) {
        const latestImageUrl = `http://13.200.229.88:9000/public/${res.data.imageFile}`;
