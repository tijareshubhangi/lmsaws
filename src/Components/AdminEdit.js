      ...
      try {
        ...
        if (res.data.success) {
          ...
          if (latestImage) {
            ...
            setAdminImage("http://15.207.19.75:9000/assets/images/avatar/07.jpg"); 
            setPreview("http://15.207.19.75:9000/assets/images/avatar/07.jpg");
...
console.log("Stored Image URL in LocalStorage: ", storedImage);    if (storedImage) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.status === 200) {
        const latestImageUrl = `http://15.207.19.75:9000/public/${res.data.imageFile}`;
